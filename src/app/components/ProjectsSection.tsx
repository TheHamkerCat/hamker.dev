  ...
  if (error) {
    return (
      <div className="min-h-[400px] flex items-center justify-center">
        <div className="bg-white/60 dark:bg-black/40 rounded-none p-6 text-orange-500">
    ...
    <div id="projects">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project) => (
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-none blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
            <div className="relative bg-white/60 dark:bg-black/40 rounded-none p-6 border border-white/20 dark:border-white/10 transition-all duration-300 group-hover:border-yellow-500/50 h-full flex flex-col"
            >
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tech.map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 
              ...
              <div className="flex justify-between items-center mt-auto">
                ...
                <a
                  ...
                  className="p-2 text-zinc-600 dark:text-zinc-400 hover:text-yellow-500 dark:hover:text-yellow-400 transition-colors"
                >
